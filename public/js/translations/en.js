...
window.translations.en = {
    ...
    healthMonitoringDesc: "Account × Model Health Status",
    healthyPairs: "HEALTHY",
    warningPairs: "WARNING",
    criticalPairs: "CRITICAL",
    disabledPairs: "DISABLED",
    healthScoreAbove90: "Score > 90%",
    ...
    failures: "Failures",
    disabled: "Disabled",
    noHealthData: "No health data available yet",
    noHealthDataDesc: "Health data will appear after accounts make API requests",
