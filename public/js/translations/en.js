...
window.translations.en = {
    ...
    requestVolume: "Request Volume",
    analysisViews: "Advanced Analysis",
    ...
    connectAccountDesc: "Link your Google account to access Claude models.",
    ...
    // Accounts - Fingerprint & Threshold modals
    fingerprint: "Fingerprint",
    accountSettings: "Account Settings",
    viewFingerprintFor: "View Fingerprint for {email}",
    minQuotaLabel: "min:",
    healthTableEmail: "Email",
    healthTableStatus: "Status",
    statusOk: "OK",
    statusDegraded: "DEGRADED",
    healthScoringNote: "Score is adjusted for successes, rate limits, and failures with passive recovery.",
    healthSelectionNote: "Selection uses weighted health, token usage, quota, and recency (LRU).",
    clickRefreshHealth: "Click Refresh to load health data",
    confirmDeleteButton: "Confirm Delete",
    thresholdInfoText: "Set a minimum quota level for this account. When the account's quota falls below this threshold, the proxy will switch to another account with more quota remaining.",
    minimumQuotaLabel: "Minimum Quota",
    leaveEmptyGlobal: "Leave empty to use the global threshold from Settings.",
    resetToDefault: "Reset to Default",
    perModelOverrides: "Per-Model Overrides",
    add: "Add",
    noPerModelOverrides: "No per-model overrides configured.",
    ...
    history: "History",
    restoreFingerprint: "Restore this fingerprint",
    // Logs
    noEventsYet: "No events yet",
    clearLogsTitle: "Clear",
    // Models page
    activeModelsAcross: "{count} active models across {accounts} accounts",
    showAllAccountsTitle: "Show all account rows",
    capAccountRowsTitle: "Cap account rows",
    capped: "Capped",
    moreLabel: "more",
    showLess: "Show less",
    // Settings - unsaved / restore
