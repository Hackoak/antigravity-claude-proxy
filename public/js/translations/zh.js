...
window.translations.zh = {
    ...
    connected: "已连接",
    connectAccount: "连接账户",
    connectAccountDesc: "关联您的 Google 账户以使用 Claude 模型。",
    continueWithGoogle: "使用 Google 继续",
    orContinueManually: "或手动继续",
    enterAuthCode: "输入授权码",
    getAuthUrl: "获取授权 URL",
    loading: "加载中...",
    copy: "复制",
    ...
    viewFingerprintFor: "查看 {email} 的指纹",
    minQuotaLabel: "最低：",
    healthTableEmail: "邮箱",
    healthTableStatus: "状态",
    statusOk: "正常",
    statusDegraded: "降级",
    healthScoringNote: "分数根据成功、限流和失败及被动恢复调整。",
    healthSelectionNote: "选择使用健康度、令牌、配额和最近使用（LRU）加权。",
    clickRefreshHealth: "点击刷新以加载健康数据",
    confirmDeleteButton: "确认删除",
    thresholdInfoText: "为此账户设置最低配额。当配额低于此阈值时，代理将切换到其他账户。",
    minimumQuotaLabel: "最低配额",
    leaveEmptyGlobal: "留空则使用设置中的全局阈值。",
    resetToDefault: "恢复默认",
    perModelOverrides: "按模型覆盖",
    add: "添加",
    noPerModelOverrides: "未配置按模型覆盖。",
    ...
    ide: "IDE",
    plugin: "插件",
    regeneratingFingerprint: "重新生成中...",
    regenerateFingerprint: "重新生成指纹",
    history: "历史",
    restoreFingerprint: "恢复此指纹",
    noEventsYet: "暂无事件",
    clearLogsTitle: "清除",
    activeModelsAcross: "{count} 个活跃模型，共 {accounts} 个账户",
    showAllAccountsTitle: "显示所有账户行",
    capAccountRowsTitle: "限制账户行数",
    capped: "已限制",
    moreLabel: "更多",
    showLess: "收起",
    loadPresetButton: "加载预设",
    confirmReset: "确认重置",
};
