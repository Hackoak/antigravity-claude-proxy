...
window.translations.zh = {
    ...
    healthMonitoringDesc: "账号 × 模型健康状态",
    healthyPairs: "健康",
    warningPairs: "警告",
    criticalPairs: "严重",
    disabledPairs: "已禁用",
    healthScoreAbove90: "分数 > 90%",
    ...
    disabled: "已禁用",
    noHealthData: "暂无健康数据",
    noHealthDataDesc: "账号发起 API 请求后将显示健康数据",
    activeIssues: "活跃问题",
    resolve: "解决",
    issueResolved: "问题已解决",
    pageTitle: "Antigravity 控制台",
    live: "实时",
    tier: "层级",
    quota: "配额",
    tierUltra: "Ultra",
    ...
    debugModeToggled: "调试模式已{status}",
    tokenCacheToggled: "令牌缓存已{status}",
    failedToUpdateTokenCache: "更新令牌缓存失败",
    failedToUpdateDebugMode: "更新调试模式失败",
    failedToRefreshAccount: "刷新账号失败",
    failedToDeleteAccount: "删除账号失败",
    failedToReloadAccounts: "重载账号失败",
    failedToUpdateModelConfig: "更新模型配置失败",
    fieldUpdated: "{displayName} 已更新为 {value}",
    failedToUpdateField: "更新 {displayName} 失败",

    // 校验消息
    mustBeValidNumber: "{fieldName} 必须是一个有效的数字",
    mustBeAtLeast: "{fieldName} 最小不能低于 {min}",
    mustBeAtMost: "{fieldName} 最大不能超过 {max}",
    cannotBeEmpty: "{fieldName} 不能为空",
    mustBeTrueOrFalse: "值必须为 true 或 false",
