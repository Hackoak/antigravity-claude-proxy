...
window.translations.id = {
    ...
    languageDesc: "Pilih bahasa yang Anda inginkan untuk antarmuka.",
    ...
    connectAccountDesc: "Tautkan akun Google Anda untuk mengakses model Claude.",
    continueWithGoogle: "Lanjutkan dengan Google",
    orContinueManually: "Atau lanjutkan secara manual",
    enterAuthCode: "Masukkan Kode Otorisasi",
    getAuthUrl: "Dapatkan URL Auth",
    loading: "Memuat...",
    copy: "Salin",
    pasteCode: "Tempel Kode",
    pasteCodePlaceholder: "Tempel kode di sini",
    submit: "Kirim",
    dismissWarning: "Tutup peringatan",
    save: "Simpan",
    fingerprint: "Sidik Jari",
    accountSettings: "Pengaturan Akun",
    viewFingerprintFor: "Lihat Sidik Jari untuk {email}",
    minQuotaLabel: "min:",
    healthTableEmail: "Email",
    healthTableStatus: "Status",
    statusOk: "OK",
    statusDegraded: "DEGRADED",
    healthScoringNote: "Skor disesuaikan untuk sukses, batas laju, dan kegagalan dengan pemulihan pasif.",
    healthSelectionNote: "Pemilihan menggunakan kesehatan, penggunaan token, kuota, dan kebaruan (LRU) tertimbang.",
    clickRefreshHealth: "Klik Segarkan untuk memuat data kesehatan",
    confirmDeleteButton: "Konfirmasi Hapus",
    thresholdInfoText: "Tetapkan tingkat kuota minimum untuk akun ini. Saat kuota akun di bawah ambang ini, proxy akan beralih ke akun lain.",
    minimumQuotaLabel: "Kuota Minimum",
    leaveEmptyGlobal: "Kosongkan untuk menggunakan ambang global dari Pengaturan.",
    resetToDefault: "Setel Ulang ke Default",
    perModelOverrides: "Override Per-Model",
    add: "Tambah",
    noPerModelOverrides: "Tidak ada override per-model yang dikonfigurasi.",
    selectModelPlaceholder: "Pilih model...",
    addOverride: "Tambah Override",
    deviceFingerprint: "Sidik Jari Perangkat",
    deviceId: "ID Perangkat",
    userAgent: "User Agent",
    platform: "Platform",
    created: "Dibuat",
    advancedDetails: "Detail Lanjutan",
    apiClient: "Klien API",
    quotaUser: "Pengguna Kuota",
    ...
    ide: "IDE",
    plugin: "Plugin",
    regeneratingFingerprint: "Regenerating...",
    regenerateFingerprint: "Regenerasi Sidik Jari",
    history: "Riwayat",
    restoreFingerprint: "Pulihkan sidik jari ini",
    noEventsYet: "Belum ada acara",
    clearLogsTitle: "Bersihkan",
    activeModelsAcross: "{count} model aktif di {accounts} akun",
    showAllAccountsTitle: "Tampilkan semua baris akun",
    capAccountRowsTitle: "Batasi baris akun",
    capped: "Terbatas",
    moreLabel: "lainnya",
    showLess: "Tampilkan lebih sedikit",
    loadPresetButton: "Muat Preset",
