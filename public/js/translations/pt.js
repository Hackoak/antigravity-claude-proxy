...
window.translations.pt = {
    ...
    connectAccountDesc: "Vincule sua conta Google para acessar os modelos Claude.",
    continueWithGoogle: "Continuar com Google",
    orContinueManually: "Ou continuar manualmente",
    enterAuthCode: "Inserir código de autorização",
    getAuthUrl: "Obter URL de autenticação",
    loading: "Carregando...",
    copy: "Copiar",
    pasteCode: "Colar código",
    pasteCodePlaceholder: "Colar código aqui",
    submit: "Enviar",
    dismissWarning: "Dispensar aviso",
    save: "Salvar",
    fingerprint: "Impressão digital",
    accountSettings: "Configurações da conta",
    viewFingerprintFor: "Ver impressão digital de {email}",
    minQuotaLabel: "mín:",
    healthTableEmail: "E-mail",
    healthTableStatus: "Status",
    statusOk: "OK",
    statusDegraded: "DEGRADADO",
    healthScoringNote: "A pontuação é ajustada por sucessos, limites de taxa e falhas com recuperação passiva.",
    healthSelectionNote: "A seleção usa saúde, uso de tokens, cota e recência (LRU) ponderados.",
    clickRefreshHealth: "Clique em Atualizar para carregar dados de saúde",
    confirmDeleteButton: "Confirmar exclusão",
    thresholdInfoText: "Defina um nível de cota mínimo para esta conta. Quando a cota ficar abaixo deste limite, o proxy mudará para outra conta.",
    minimumQuotaLabel: "Cota mínima",
    leaveEmptyGlobal: "Deixe vazio para usar o limite global nas Configurações.",
    resetToDefault: "Restaurar padrão",
    perModelOverrides: "Substituições por modelo",
    add: "Adicionar",
    noPerModelOverrides: "Nenhuma substituição por modelo configurada.",
    selectModelPlaceholder: "Selecionar modelo...",
    addOverride: "Adicionar substituição",
    deviceFingerprint: "Impressão digital do dispositivo",
    ...
    ide: "IDE",
    plugin: "Plugin",
    regeneratingFingerprint: "Regenerando...",
    regenerateFingerprint: "Regenerar impressão digital",
    history: "Histórico",
    restoreFingerprint: "Restaurar esta impressão digital",
    noEventsYet: "Nenhum evento ainda",
    clearLogsTitle: "Limpar",
    activeModelsAcross: "{count} modelos ativos em {accounts} contas",
    showAllAccountsTitle: "Mostrar todas as linhas de conta",
    capAccountRowsTitle: "Limitar linhas de conta",
    capped: "Limitado",
    moreLabel: "mais",
    showLess: "Mostrar menos",
    loadPresetButton: "Carregar predefinição",
