...
window.translations.tr = {
    ...
    connectAccountDesc: "Claude modellerine erişmek için Google hesabınızı bağlayın.",
    continueWithGoogle: "Google ile devam et",
    orContinueManually: "Veya manuel devam et",
    enterAuthCode: "Yetkilendirme kodunu girin",
    getAuthUrl: "Auth URL al",
    loading: "Yükleniyor...",
    copy: "Kopyala",
    pasteCode: "Kodu yapıştır",
    pasteCodePlaceholder: "Kodu buraya yapıştırın",
    submit: "Gönder",
    dismissWarning: "Uyarıyı kapat",
    save: "Kaydet",
    fingerprint: "Parmak izi",
    accountSettings: "Hesap ayarları",
    viewFingerprintFor: "{email} için parmak izini görüntüle",
    minQuotaLabel: "min:",
    healthTableEmail: "E-posta",
    healthTableStatus: "Durum",
    statusOk: "OK",
    statusDegraded: "DÜŞÜK",
    healthScoringNote: "Puan, başarılar, oran sınırları ve pasif iyileşmeli hatalara göre ayarlanır.",
    healthSelectionNote: "Seçim, sağlık, token kullanımı, kota ve güncellik (LRU) ağırlıklı kullanır.",
    clickRefreshHealth: "Sağlık verilerini yüklemek için Yenile'ye tıklayın",
    confirmDeleteButton: "Silmeyi onayla",
    thresholdInfoText: "Bu hesap için minimum kota düzeyi belirleyin. Kota bu eşiğin altına düştüğünde proxy başka bir hesaba geçer.",
    minimumQuotaLabel: "Minimum kota",
    leaveEmptyGlobal: "Ayarlardaki genel eşiği kullanmak için boş bırakın.",
    resetToDefault: "Varsayılana sıfırla",
    perModelOverrides: "Model başına geçersiz kılmalar",
    add: "Ekle",
    noPerModelOverrides: "Model başına geçersiz kılma yapılandırılmadı.",
    ...
    quotaUser: "Kota kullanıcısı",
    sessionToken: "Oturum belirteci",
    metadata: "Meta veri",
    osVersion: "OS sürümü",
    arch: "Mimari",
    ide: "IDE",
    plugin: "Eklenti",
    regeneratingFingerprint: "Yeniden oluşturuluyor...",
    regenerateFingerprint: "Parmak izini yeniden oluştur",
    history: "Geçmiş",
    restoreFingerprint: "Bu parmak izini geri yükle",
    noEventsYet: "Henüz olay yok",
    clearLogsTitle: "Temizle",
    activeModelsAcross: "{accounts} hesapta {count} aktif model",
    showAllAccountsTitle: "Tüm hesap satırlarını göster",
    capAccountRowsTitle: "Hesap satırlarını sınırla",
    capped: "Sınırlı",
    moreLabel: "daha fazla",
    showLess: "Daha az göster",
    loadPresetButton: "Ön ayarı yükle",
